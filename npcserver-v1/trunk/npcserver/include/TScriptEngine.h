...
protected:
	...
	//GM Set and Get
	virtual static void GM_CDECL TScriptGetDot(gmThread * a_thread, gmVariable * a_operands);
	virtual static void GM_CDECL TScriptSetDot(gmThread * a_thread, gmVariable * a_operands);
