...
class CAccount
{
	public:
		...
		char colors[5];
		int adminRights, ap, apCounter, bombs, bombPower, darts, deaths, glovePower, horseBushes, kills, lastIp, magicPoints, onlineSecs, rubins, shieldPower, sprite, status, swordPower;
