...
enum {
	CANWARPXY			= 0x00001,
	CANWARPTOPLAYER		= 0x00002,
	CANWARPPLAYER		= 0x00004,
	CANUPDATELEVEL		= 0x00008,
	CANDISCONNECT		= 0x00010,
	CANVIEWATTRIBS		= 0x00020,
	CANSETATTRIBS		= 0x00040,
	CANSETOWNATTRIBS	= 0x00080,
	CANRESETATTRIBS		= 0x00100,
	CANADMINMSG			= 0x00200,
	CANCHANGERIGHTS		= 0x00400,
	CANBAN				= 0x00800,
	CANCHANGECOMMENTS	= 0x01000,
	CANINVISONLIST		= 0x02000,
	CANCHANGESTAFFACC	= 0x04000,
	CANSETSERVERFLAG	= 0x08000,
	CANEDITSERVEROPTION	= 0x10000,
	CANEDITFOLDEROPTION	= 0x20000,
	CANEDITFOLDERRIGHTS	= 0x40000,
...
class CPlayer : public CAccount
{
	public:
		...
		int additionalFlags, carrySprite, failAttempts, key, iterator, id, packCount, udpPort;
